...
function preload(){
  ...
  backgroundImg = loadImage("Image/Night.jpeg");
  
    thunder1 = loadImage("Image/download (1).png");
    thunder2 = loadImage("Image/download (2).png");
}
...
function draw(){
    ...
    if(frameCount % 1 === 0){
      var raindrop = new Rain(random(0, windowWidth), -100,10);
